...
import { Star, ChevronRight, Globe, FileText, Clock, Shield } from "lucide-react";
      ...
      <main className="px-4 py-8 md:px-8 lg:px-16">
        <nav className="flex mb-8" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <ChevronRight className="h-5 w-5 text-gray-400" />
                <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">FLA Return Filing</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-3 space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-blue-600 p-8 text-white">
                  ...
                  <p className="text-blue-100 mb-6">
                    File Foreign Liability and Asset (FLA) returns with RBI compliance and expert assistance.
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-6 h-full">
                    <div className="space-y-4">
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                        ...
                        <h3 className="font-semibold text-gray-800">Foreign Assets</h3>
                        <p className="text-sm text-gray-600">Overseas investments</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500">
                        <FileText className="h-8 w-8 text-green-600 mb-2" />
                        <h3 className="font-semibold text-gray-800">RBI Compliance</h3>
                        <p className="text-sm text-gray-600">FEMA regulations</p>
                      </div>
                    </div>
                    <div className="space-y-4">
            ...
            <Card className="p-8">
              <h2 className="text-2xl font-bold mb-6 text-blue-600">FLA Return Filing Requirements</h2>
              <p className="text-gray-700 mb-4">
                Indian residents with foreign assets or liabilities must file FLA returns with RBI.
              </p>
