...
import { Star, ChevronRight, Users, Building, Shield, FileText } from "lucide-react";
                  ...
                  <div className="grid grid-cols-2 gap-6 h-full">
                    <div className="space-y-4">
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                        ...
                        <p className="text-sm text-gray-600">Partnership firms</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-green-500">
                        <Building className="h-8 w-8 text-green-600 mb-2" />
                        <h3 className="font-semibold text-gray-800">LLP</h3>
                        <p className="text-sm text-gray-600">Limited Liability Partnerships</p>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-orange-500">
                        ...
                        <p className="text-sm text-gray-600">Association/Body of Persons</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-purple-500">
                        <FileText className="h-8 w-8 text-purple-600 mb-2" />
                        <h3 className="font-semibold text-gray-800">Trusts</h3>
                        <p className="text-sm text-gray-600">Cooperative societies</p>
                      </div>
                    </div>
                  </div>
                </div>
