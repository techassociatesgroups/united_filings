        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              LLP Form 11 Filing Service
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              Professional LLP Form 11 filing service for annual return submission. Ensure compliance with LLP regulations and avoid penalties.
            </p>
            <div className="flex items-center space-x-4">
              <span className="text-3xl font-bold text-green-600">₹3,499</span>
              <span className="text-gray-500 line-through">₹4,999</span>
              <span className="bg-red-100 text-red-800 px-2 py-1 rounded text-sm">30% OFF</span>
            </div>
