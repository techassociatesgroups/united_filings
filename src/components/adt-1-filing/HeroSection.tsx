        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              ADT-1 Filing Service
            </h1>
            <p className="text-xl text-gray-600 mb-6">
              Professional ADT-1 form filing service for appointment of auditor in companies. Ensure compliance with statutory audit requirements.
            </p>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-gray-600">
                  <li>• ADT-1 Form Preparation</li>
                  <li>• Auditor Consent Processing</li>
