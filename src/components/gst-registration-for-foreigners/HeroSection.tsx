    ...
    <section>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        <div className="md:col-span-1">
          <img
            src="assets/gst-foreigner.jpeg"
            alt="GST Registration for Foreigners"
        ...
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-gray-600">
            GST registration as non-resident taxable person with LEDGERS
            Accounting software.
          </p>
            ...
            <div className="border rounded-lg p-4 shadow-sm bg-stone-50 border-dashed border-orange-400">
              ...
              <ul className="space-y-1 text-gray-600 mt-3 text-sm">
                <li className="flex items-start">
                  ...
                  <span>Indian Authorized Representative</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                ...
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>1 Year GST Filing & Compliance</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>GST Payment Facilitation</span>
                </li>
              </ul>
              <SendRequestButton
