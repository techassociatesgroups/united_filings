      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-gray-600">
            Completely managed GST amendment of Core field and Non-Core field in
            GST portal by changing Trade name, Contact details, Business
            activities, Changing the principal place of the business address,
            and Adding additional places of business with expert support.
          </p>
            ...
            <div className="border rounded-lg p-4 shadow-sm bg-stone-50 border-dashed border-orange-400">
              ...
              <ul className="space-y-1 text-gray-600 mt-3 text-sm">
                <li className="flex items-start">
                  ...
                  <span>Assisted GST Amendment Filing</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>Updated GST Registration Certificate</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>Amendment Acknowledgement</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>Documentation & GST Advisory</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>Support Until Approval</span>
                </li>
              </ul>
