    ...
    <section>
        <div className="border rounded-lg p-6 shadow-sm bg-stone-50 border-dashed border-orange-400">
            ...
            <ul className="space-y-2 text-gray-600 mt-4 text-sm">
                <li className="flex items-start"><ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" /> <span>Preparation of LUT Application</span></li>
                <li className="flex items-start"><ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" /> <span>Filing of LUT on GST Portal</span></li>
                <li className="flex items-start"><ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" /> <span>LUT Acknowledgement (FY-wise)</span></li>
