      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="md:col-span-2">
          ...
          <p className="mt-4 text-gray-600">
            A taxable person whose GST registration is cancelled or surrendered
            has to file a return in Form GSTR-10 called as Final Return. This is
            statement of stocks held by such taxpayer on day immediately
            preceding the date from which cancellation is made effective.
          </p>
            ...
            <div className="border rounded-lg p-4 shadow-sm bg-stone-50 border-dashed border-orange-400">
              ...
              <ul className="space-y-1 text-gray-600 mt-3 text-sm">
                <li className="flex items-start">
                  ...
                  <span>Filed GSTR 10</span>
                </li>
                <li className="flex items-start">
                  <ChevronRight className="h-4 w-4 text-green-500 mr-2 flex-shrink-0 mt-1" />{" "}
                  <span>Acknowledgement Copy</span>
                </li>
              </ul>
