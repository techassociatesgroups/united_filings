...
const OffersSection = () => {
  return (
    <section>
      <div className="mt-8">
        <h2 className="text-xl font-bold text-gray-800 mb-6">Our GSTR-10 Filing Services</h2>
        <div className="border rounded-lg p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold">GSTR-10 Return Filing</h3>
            <span className="text-lg font-bold text-green-600">₹999</span>
          </div>
          <ul className="space-y-2 text-sm text-gray-600 mb-4">
            <li>• Complete GSTR-10 preparation</li>
            <li>• Data validation and verification</li>
            <li>• Online filing</li>
            <li>• Acknowledgment receipt</li>
          </ul>
          <AddToCartButton 
            serviceName="GSTR-10 Return Filing" 
            price={999}
