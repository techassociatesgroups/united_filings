      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Limited time offers on our MOA amendment services
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">38% OFF</h3>
            <p className="text-gray-600 mb-4">On all MOA amendment services</p>
            <p className="text-3xl font-bold text-green-600">₹4,999</p>
            <p className="text-gray-500 line-through">₹7,999</p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Express Service</h3>
            <p className="text-gray-600 mb-4">Fast-track processing in 7 days</p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">MOA + AOA</h3>
            <p className="text-gray-600 mb-4">Both amendments together</p>
