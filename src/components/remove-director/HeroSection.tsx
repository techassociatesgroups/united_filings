        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Professional assistance for removing directors from your company. Ensure proper compliance and documentation for director removal process.
            </p>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li>• DIR-11 Form Filing</li>
                  <li>• Resignation Documentation</li>
