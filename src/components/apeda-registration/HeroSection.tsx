    ...
    <Card className="overflow-hidden">
      <div className="grid md:grid-cols-12">
        <div className="md:col-span-5 flex items-center justify-center p-4 bg-black">
           <img src="/lovable-uploads/4d2152ea-52ce-4df7-9c61-5f33597357f7.png" alt="APEDA Registration" className="object-contain rounded-lg max-h-[450px]" />
        </div>
        <div className="md:col-span-7 p-8">
          <h1 className="text-3xl font-bold">APEDA Registration</h1>
          ...
          <Card className="border-green-200 mt-6">
            <CardContent className="p-4">
              ...
              <h3 className="font-bold mb-2">APEDA</h3>
