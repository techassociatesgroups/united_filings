      ...
      <div className="grid md:grid-cols-12 gap-0">
        ...
        <div className="md:col-span-7 lg:col-span-8 p-8">
          ...
          <p className="text-gray-600 mb-4">
            According to RERA act 2016, RERA registered agents has the authority
            to deal the real estate sector. They legally can indulge in the
            process of selling and purchasing of real estate properties which
            are registered under section 3 of the act.
          </p>
