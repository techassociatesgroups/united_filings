        ...
        <div className="p-1">
          ...
          <div className="border rounded-lg p-6 bg-gray-50">
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li className="flex items-start"><ChevronRight className="w-4 h-4 mr-2 mt-1 text-gray-400 flex-shrink-0" /> DIN E-KYC for 1 Director</li>
              <li className="flex items-start"><ChevronRight className="w-4 h-4 mr-2 mt-1 text-gray-400 flex-shrink-0" /> Income Tax Filing</li>
              <li className="flex items-start"><ChevronRight className="w-4 h-4 mr-2 mt-1 text-gray-400 flex-shrink-0" /> MCA Annual Return Filing</li>
