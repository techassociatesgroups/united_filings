...
const OffersSection = () => {
  return (
    <section>
      <div className="mt-8">
        <h2 className="text-xl font-bold text-gray-800 mb-6">Our GST Notice Services</h2>
        <div className="border rounded-lg p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold">GST Notice Response</h3>
            <span className="text-lg font-bold text-green-600">₹2,999</span>
          </div>
          <ul className="space-y-2 text-sm text-gray-600 mb-4">
            <li>• Notice analysis and review</li>
            <li>• Response preparation</li>
            <li>• Document compilation</li>
            <li>• Filing and follow-up</li>
          </ul>
          <AddToCartButton 
            serviceName="GST Notice Response" 
            price={2999}
