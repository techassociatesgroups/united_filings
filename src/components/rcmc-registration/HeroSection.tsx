      ...
      <div className="grid md:grid-cols-12 gap-0">
        ...
        <div className="md:col-span-7 lg:col-span-8 p-8">
          ...
          <p className="text-gray-600 mb-4">
            ...
            validates an exporter dealing with products registered with an
            agency/organization that the Indian Government authorizes.
          </p>
