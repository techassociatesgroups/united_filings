        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Professional assistance for changing directors in your company. Ensure compliance with statutory requirements and seamless transition.
            </p>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li>• DIN-3 Form Filing</li>
                  <li>• DIR-12 Form Processing</li>
                  <li>• MCA Liaison</li>
