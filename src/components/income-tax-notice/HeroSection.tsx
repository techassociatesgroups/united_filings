        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Expert assistance for responding to Income Tax notices. Get professional help to resolve tax disputes and ensure compliance.
            </p>
