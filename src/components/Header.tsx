            ...
            {user ? (
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="bg-white border border-gray-300 text-gray-700 px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors flex items-center space-x-2"
                >
