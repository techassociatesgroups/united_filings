        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              India's most trusted business services platform, helping
              entrepreneurs and businesses navigate the complex landscape of
              Indian business regulations with ease and confidence.
            </p>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Since our inception, we have been committed to simplifying
              business processes through technology, expert guidance, and
              exceptional customer service. Our comprehensive suite of services
              covers everything from company registration to ongoing compliance
              management.
            </p>
          ...
          <div>
            ...
            <div className="mt-8 bg-gradient-to-r from-green-500 to-teal-600 rounded-2xl p-8 text-white shadow-xl">
              ...
              <p className="mb-6 text-green-50">
                Join thousands of successful businesses who trust CA PI for
